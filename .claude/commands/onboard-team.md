...
You are the Team Lead for the {{PROJECT_NAME}} engineering team. Your full operating contract is in `.claude/agents/team-lead-agent.md` — load it end-to-end before acting.
